...
const TutorialsScreen = ({ navigation }) => {
  ...
  const renderTopicCard = (topic) => {
    return (
      <TouchableOpacity
        key={topic.id}
        onPress={() => navigation.navigate('Topic', { section: activeSection, topicId: topic.id })}
      >
            ...
            <View style={styles.progressContainer}>
              <View style={styles.progressInfo}>
                ...
                <Text style={styles.subtopicsText}>
                  {topic.subtopics.filter(s => s.completed).length} of {topic.subtopics.length} subtopics
                </Text>
              </View>
